...
Begin VB.MDIForm Menu 
   ...
   Begin ComctlLib.Toolbar tbrPrincipal 
      ...
      BeginProperty Buttons {0713E452-850A-101B-AFC0-4210102A8DA7} 
         ...
         BeginProperty Button3 {0713F354-850A-101B-AFC0-4210102A8DA7} 
            Object.ToolTipText     =   "Planilla Diaria"
            Object.Tag             =   ""
            ImageIndex      =   2
         EndProperty
   ...
   Begin VB.Menu mnuReportes 
      ...
      Begin VB.Menu mnuReporteTurnos 
         Caption         =   "Programa de Viandas por Cliente"
      End
      Begin VB.Menu mnuRepPacientes 
         Caption         =   "Topo de Facturacion por Cliente"
      End
      Begin VB.Menu mnuFacturacionfechas 
         Caption         =   "Facturacion entre Fechas"
      End
   End
...
Private Sub MDIForm_Load()
    ...
    Me.Caption = "SIAP - Servicio Integral de Alimentacion Profesional"
...
'    DSN_DEF = "VAUDAGNA"
    ...
    DBConn.ConnectionString = "Provider=MSDASQL.1;Persist Security Info=False;Data Source=SISIAP"
...
Private Sub mnuAsignarTurnos_Click()
 '   MsgBox "En construccion", vbInformation, TIT_MSGBOX
    frmPlanillaDiaria.Show
End Sub
...
Private Sub mnuFacturacion2_Click()
MsgBox "En construccion", vbInformation, TIT_MSGBOX
End Sub

Private Sub mnuFacturacionfechas_Click()
MsgBox "En construccion", vbInformation, TIT_MSGBOX
End Sub
...
Private Sub mnuRepPacientes_Click()
MsgBox "En construccion", vbInformation, TIT_MSGBOX
End Sub
...
Private Sub mnuViandas_Click()
    Dim cSQL As String
    
    mOrigen = True
        
    Set vABMVianda = New CListaBaseABM
    ...
    With vABMVianda
        ...
        .FieldID = "VIA_CODIGO"
        '.Report = RptPath & "tipocomp.rpt"
        Set .FormBase = vFormVianda
        Set .FormDatos = ABMVianda
    End With
    
    Set auxDllActiva = vABMVianda
